...
namespace PKISharp.WACS.Plugins.Base.Factories.Null
{
    ...
    internal class NullCsrFactory : ICsrPluginOptionsFactory, INull
    {
        ...
        Task<CsrPluginOptions?> IPluginOptionsFactory<CsrPluginOptions>.Acquire(IInputService inputService, RunLevel runLevel) => Task.FromResult<CsrPluginOptions?>(null);
