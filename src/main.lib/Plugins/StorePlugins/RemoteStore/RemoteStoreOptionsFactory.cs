...
{
    public class RemoteStoreOptionsFactory : StorePluginOptionsFactory<RemoteStore, RemoteStoreOptions>
    {
        private readonly ArgumentsInputService _arguments;
        private readonly IIISClient _iisClient;
        private readonly ISettingsService _settingsService;

        public RemoteStoreOptionsFactory(
        ...
        public override async Task<RemoteStoreOptions?> Acquire(IInputService inputService, RunLevel runLevel)
        {
        ...
        public override async Task<RemoteStoreOptions?> Default()
        {
            return new RemoteStoreOptions
            {
                ...
                AclFullControl = (await _arguments.
                    GetString<RemoteStoreArguments>(x => x.AclFullControl).
                    GetValue()).ParseCsv()
            };
        }
    }
